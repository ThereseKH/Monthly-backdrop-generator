...
!(function (a) {
  ...
  function h(a, c) {
    function d(a) {
      ...
      if (
        ((b.width = c.width || window.devicePixelRatio * q.width(a)),
        (b.height = c.height || window.devicePixelRatio * q.height(a)),
        c.bgcolor)
      ) {
    ...
    function f(a, b) {
      function c() {
        function c(a, b) {
          ...
          "" == b.fontStretch,
            a.cssText ? ((b.cssText = a.cssText), (b.font = a.font)) : c(a, b),
  ...
  function m() {
        ...
        new Promise(function (c) {
          function d() {
            if (4 === g.readyState) {
              if (200 !== g.status)
                return void (h
                  ? c(h)
                  : f("cannot fetch resource: " + a + ", status: " + g.status));
          ...
          function e() {
            h
              ? c(h)
              : f(
                  "timeout of " + b + "ms occured while fetching resource: " + a
                );
          }
          function f(a) {
            console.error(a), c("");
    ...
    function q(a) {
      var b = s(a, "border-left-width"),
        c = s(a, "border-right-width");
      return a.scrollWidth + b + c;
    }
    function r(a) {
      var b = s(a, "border-top-width"),
        c = s(a, "border-bottom-width");
    ...
    function b() {
      ...
      function b(a) {
        ...
        function d(a) {
          ...
          return (c.textContent = a), b.body.appendChild(c), c.sheet;
        }
        return Promise.all(
          a.map(function (a) {
            return a.href
              ? fetch(a.href).then(b).then(c(a.href)).then(d)
              : Promise.resolve(a);
          })
        );
      }
      function c(a) {
        ...
        return (
          a.forEach(function (a) {
            if (a.cssRules && "object" == typeof a.cssRules)
              try {
